...
<tr><td style="height: 5px;"></td></tr>
<tr><td colspan="3" align="center" style="font-size: small;">If you don\'t have an account, you can create one using the command:<br />/rm register &lt;somepassword&gt;</td></tr>
</table>
</form>
...
<div id="title-box">
  <div id="title-box2">
    <h1 style="margin-bottom: 10px; text-align: center; font-family: Arial;">Rhythm</h1>
    <h2>{page title}</h2>
  </div>
</div>
';
...
<tr><td style="height: 1px;"><h1 style="margin-bottom: 30px; text-align: center; font-family: Arial; font-size: 45px;">Rhythm</h1></td></tr>
<tr><td>
';
}
